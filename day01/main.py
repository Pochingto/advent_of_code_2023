...
def replace_first_letter(line: str) -> str:
    ...
    if len(letter_idx) != 0:
        ...
        line = (
            line[:first_letter_idx]
            + LETTER2DIGIT[first_letter]
            + line[first_letter_idx + len(first_letter) :]
        )
...
def replace_last_letter(line: str) -> str:
    ...
    if len(letter_idx) != 0:
        ...
        line = (
            line[:last_letter_idx]
            + LETTER2DIGIT[last_letter]
            + line[last_letter_idx + len(last_letter) :]
        )
